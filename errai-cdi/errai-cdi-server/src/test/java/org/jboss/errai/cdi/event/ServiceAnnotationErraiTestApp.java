...
package org.jboss.errai.cdi.event;
 ...
 */
@ErraiApp(gwtModuleName = "org.jboss.errai.cdi.event.ServiceAnnotationTestModule",
          modules = { ErraiMarshallingModule.class,
                      ...
                      ServiceAnnotationErraiTestApp.class })
@ErraiModule
public class ServiceAnnotationErraiTestApp {
}
