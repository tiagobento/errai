...
package org.jboss.errai.cdi.async.test.databinding;
 ...
 */
@ErraiApp(gwtModuleName = "org.jboss.errai.cdi.async.test.databinding.AsyncCDIDatabindingTest",
          modules = { ErraiMarshallingModule.class,
                      ...
                      AsyncCdiDataBindingErraiTestApp.class })
@ErraiModule
public class AsyncCdiDataBindingErraiTestApp {
}
